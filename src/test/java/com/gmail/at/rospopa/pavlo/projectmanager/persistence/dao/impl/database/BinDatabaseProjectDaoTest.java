...
import com.gmail.at.rospopa.pavlo.projectmanager.persistence.database.impl.bin.PMBinDatabase;
...
public class BinDatabaseProjectDaoTest extends ProjectDaoTest {
    private static final String rootDirectoryPath = PropertiesLoader.getInstance()
            .getBinDBProperties().getProperty("bin.database.test.rootDirectoryPath");

    private PMBinDatabase database;

    public BinDatabaseProjectDaoTest() {
        database = new PMBinDatabase(Paths.get(rootDirectoryPath), true);
